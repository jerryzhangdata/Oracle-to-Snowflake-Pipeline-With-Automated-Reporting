...
To test the pipeline, we will insert dummy data into the Oracle database and verify that Fivetran syncs the update to snowflake. We first connect to the Oracle database as the Admin user, and run the SQL below to 
